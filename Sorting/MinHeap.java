...
public class MinHeap<T extends Comparable<? super T>> {
    ...
    /**
     * Creates a Heap with an initial capacity of INITIAL_CAPACITY for the backing
     * array.
     *
     ...
     *
     * The data in the backingArray should be in the same order as it appears in the
     * passed in ArrayList before you start the Build Heap Algorithm.
     *
     * The backingArray should have capacity 2n + 1 where n is the number of data in
     * the passed in ArrayList (not INITIAL_CAPACITY from the interface). Index 0
     * should remain empty, indices 1 to n should contain the data in proper order,
     * and the rest of the indices should be empty.
     *
    ...
    /**
     * Adds an item to the heap. If the backing array is full and you're trying to
     * add a new item, then double its capacity.
     *
