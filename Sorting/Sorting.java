...
public class Sorting {
     ...
     *
     * It should be: in-place unstable
     *
     * Have a worst case running time of: O(n^2)
     *
     ...
     *
     * It should be: out-of-place stable
     *
     ...
     *
     * @throws IllegalArgumentException if the array or comparator or rand is null
     * @param <T>        data type to sort
     * @param arr        the array that must be sorted after the method runs
     * @param comparator the Comparator used to compare the data in arr
     ...
     * the number of iterations you need.
     *
     * Refer to the PDF for more information on LSD Radix Sort.
     *
     * You may use {@code java.util.ArrayList} or {@code java.util.LinkedList} if
     * you wish, but it may only be used inside radix sort and any radix sort
